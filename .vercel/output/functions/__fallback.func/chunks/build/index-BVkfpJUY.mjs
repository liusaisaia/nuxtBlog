...
import { _ as __nuxt_component_0$1 } from './PostCard-CltROFxH.mjs';
import { defineComponent, withAsyncContext, computed, mergeProps, withCtx, createTextVNode, unref, createVNode, toDisplayString, openBlock, createBlock, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/tags",
        class: "px-5 py-3 rounded-xl border border-soft text-soft hover:text-[var(--text)] hover:border-strong transition-colors text-sm font-medium"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` 查看主题标签 `);
...
//# sourceMappingURL=index-BVkfpJUY.mjs.map

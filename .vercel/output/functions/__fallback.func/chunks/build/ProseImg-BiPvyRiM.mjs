...
import { a7 as withLeadingSlash, Y as withTrailingSlash, I as joinURL, U as defu, N as hasProtocol, K as parseURL, a8 as encodeParam, L as encodePath } from '../nitro/nitro.mjs';
import { b as useRuntimeConfig, u as useHead, e as useNuxtApp } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const ipxRuntime$_45lE19RSaDR7QBO8c77WEsY0JrWfz57EZuw7RtosEaDM = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$_45lE19RSaDR7QBO8c77WEsY0JrWfz57EZuw7RtosEaDM, defaults: {} }
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+image@2.0.0_db0@0.3.4_@libsql+client@0.14.0_better-sqlite3@12.6.2_drizzle-orm@0.45.1_@l_bc2xmqqrykd4np5s4qvxgmphai/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxtjs+mdc@0.20.1_magicast@0.5.2/node_modules/@nuxtjs/mdc/dist/runtime/components/prose/ProseImg.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ProseImg-BiPvyRiM.mjs.map

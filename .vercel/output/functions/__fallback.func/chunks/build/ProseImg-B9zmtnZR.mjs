import { computed, createVNode, resolveDynamicComponent, unref, mergeProps, ref, useAttrs, useTemplateRef, useSSRContext } from 'vue';
import { ssrRenderVNode, ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
import { S as withLeadingSlash, T as withTrailingSlash, n as joinURL, U as defu, z as hasProtocol, V as withLeadingSlash$1, B as joinURL$1, w as parseURL, W as encodeParam, x as encodePath } from '../nitro/nitro.mjs';
import { c as useRuntimeConfig, u as useHead, d as useNuxtApp } from './server.mjs';
import 'jose';
import 'node:http';
import 'node:https';
import 'node:events';
...
function resolveImage(ctx, input, options) {
  ...
  input = hasProtocol(input) ? input : withLeadingSlash$1(input);
...
const ipxRuntime$QcKXVlBSWsySN3FgHX3Iin_456MMv72Eqt_D3yAMt17rA = defineProvider({
  ...
  getImage: (src, { modifiers, baseURL }, ctx) => {
    ...
    if (!baseURL) {
      baseURL = joinURL$1(ctx.options.nuxt.baseURL, "/_ipx");
    }
    return {
      url: joinURL$1(baseURL, params, encodePath(src))
    };
  }
});
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$QcKXVlBSWsySN3FgHX3Iin_456MMv72Eqt_D3yAMt17rA, defaults: {} }
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+image@2.0.0_db0@0.3.4_better-sqlite3@12.6.2_drizzle-orm@0.45.1_@types+better-sqli_7507748ea71c26af123163afcd9ba9db/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
...
//# sourceMappingURL=ProseImg-B9zmtnZR.mjs.map

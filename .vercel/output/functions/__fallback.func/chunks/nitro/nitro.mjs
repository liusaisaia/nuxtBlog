...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "b47339a7-2322-4530-8f40-d2067feec44d",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Volumes/data/Users/saisaia/Documents/study/nuxtBlog/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const checksums = {
  "content": "v3.5.0--wwAWEnMT4bXZiKJreCr4m5kwTpyjbdfZGavv4fEQkWI"
};
const checksumsStructure = {
  "content": "aC0atAajl6VHfZVY6nZ7jufyZRSm2fJWppKowOalAjw"
};
...
const _lazy_36e7HH = () => import('../routes/api/admin/categories/_id_.delete.mjs');
...
const handlers = [
  ...
  { route: '/api/admin/posts/:id', handler: _lazy_iR0eWn, lazy: true, middleware: false, method: "put" },
  { route: '/api/admin/posts', handler: _lazy_kkqwZ_, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/posts', handler: _lazy_oQP67V, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/settings', handler: _lazy_tq8VYk, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/settings', handler: _lazy_VARTxH, lazy: true, middleware: false, method: "put" },
